...
<%--&lt;%&ndash;        <form:hidden path="hotelId" />&ndash;%&gt;--%>

<%--        <table>--%>
<%--            <tbody>--%>
<%--            <tr>--%>
<%--                <td><label>Hotel name:</label></td>--%>
<%--&lt;%&ndash;                <td><form:input  path="nameHotel" /></td>&ndash;%&gt;--%>
<%--            </tr>--%>

<%--            <tr>--%>
<%--                <td><label>Country:</label></td>--%>
<%--&lt;%&ndash;                <td><form:input path="country" /></td>&ndash;%&gt;--%>
<%--            </tr>--%>

<%--            <tr>--%>
<%--                <td><label>City:</label></td>--%>
<%--&lt;%&ndash;                <td><form:input path="city" /></td>&ndash;%&gt;--%>
<%--            </tr>--%>

<%--            <tr>--%>
<%--                <td><label>Description:</label></td>--%>
<%--&lt;%&ndash;                <td><form:input path="description" /></td>&ndash;%&gt;--%>
<%--            </tr>--%>

                ...
                <tr scope="row" >
                    ...
                    <td ><button type="button" class="btn btn-outline-secondary btn-rounded   " data-mdb-ripple-color="#000000">
                        <a  class="btn-outline-secondary    " data-mdb-ripple-color="#000000"
                            style="color: #89a9c6; border-color: #89a9c6;" href="${cancelOrder}" onclick="if (!(confirm('Are you sure you want to  cancel this reservation ?'))) return false">Cancel Reservation</a>
                    </button>
                    </td>
                </tr>
